...
class FiltrosRelatorioWidget extends StatelessWidget {
  final DateTime startDate;
  final DateTime endDate;
  final String filtroCargo;
  final Map<String, String> cargoFiltroOpcoes;
  ...
  const FiltrosRelatorioWidget({
    super.key,
    required this.startDate,
    required this.endDate,
    required this.filtroCargo,
    required this.cargoFiltroOpcoes,
                ...
                Expanded(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: Icon(
                      ...
                      color: canExport ? Colors.red.shade700 : Colors.grey,
                    ),
                    label: Text(
                      "PDF",
                      style: TextStyle(
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items:
              cargoFiltroOpcoes.entries.map((entry) {
